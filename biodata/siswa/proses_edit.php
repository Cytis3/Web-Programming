<?php
    ...
    if($nama_foto != ""){
        ...
        tgl_lahir='$tgl_lahir', alamat='$alamat', email='$email', jenis_kelamin='$jenis_kelamin',  jurusans_id  ='$jurusan',gelombang ='$gelombang', foto='$nama_foto' 
        WHERE id='$id'";
        ...
        #3. Query Insert (proses edit data)
        $query = "UPDATE biodata SET nama='$nama', nisn='$nisn', tempat_lahir='$tempat_lahir', 
        tgl_lahir='$tgl_lahir', alamat='$alamat', email='$email', jenis_kelamin='$jenis_kelamin',jurusans_id='$jurusan', gelombangs_id ='$gelombang' 
        WHERE id='$id'";
    }
